...
const ChartMarket = (props) => {
    const {getDataBlocks,arrBlockMonth} =props
    ...
    useLayoutEffect(() => {
        setTimeout(() => {
            ...
            // series.tooltipText = "[bold]{value} Blocks";
            ...
            let chart = am4core.create("chartdiv222", am4charts.XYChart);
        ...
        valueAxis.min = 0;
        valueAxis.max = arrBlockMonth[2].value + 10;
        valueAxis.cursorTooltipEnabled = false;
    ...
    }, [getDataBlocks,arrBlockMonth]);

    return (
        <div id="chartdiv222" style={{ width: "100%", height: "120px", margin: "0 auto",marginLeft:"10px" }}></div>
    );
}
