...
const ChartMining = (props) => {
    const {arrBlockWeek}= props
    const uniqueArray = a => [...new Set(a.map(o => JSON.stringify(o)))].map(s => JSON.parse(s))
    
    useLayoutEffect(() => {
        let arr = arrBlockWeek.sort(function(a,b){
        ...
        // let chart = am4core.create("chartdivMiningWeek", am4charts.XYChart);
        // chart.data = data;
        ...
        let arr_Value = arrBlockWeek.sort(function (a, b) {
        ...
        series.tooltipText = `[bold]{date.formatDate("dd/MM")} - {date2.formatDate("dd/MM")}  : {valueY} Blocks[/]`;
    ...
    return (
        <div id="chartdivMiningWeek" style={{ width: "105%", height: "360px", marginLeft: "-30px", marginTop:"40px" }}></div>
    );
}
