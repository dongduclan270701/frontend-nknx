...
import "Assets/scss/ChartMining.scss"
am4core.useTheme(am4themes_animated);
am4core.options.autoSetClassName = true;
let colors = new am4core.ColorSet();

const ChartMining = (props) => {
    const { arrBlocks } = props
    useLayoutEffect(() => {
        setTimeout(() => {
            let arr = arrBlocks.sort(function (a, b) {
            ...
            // let chart = am4core.create("chartdivMining", am4charts.XYChart);
            // chart.data = data;
            ...
            let arr_Value = arrBlocks.sort(function (a, b) {
            ...
            series.tooltipText = `[bold]{date.formatDate("dd/MM")} : {valueY} Blocks[/]`;
    ...
    return (
        <div id="chartdivMining" style={{ width: "105%", height: "360px", marginLeft: "-30px", marginTop: "40px" }}></div>
    );
}
